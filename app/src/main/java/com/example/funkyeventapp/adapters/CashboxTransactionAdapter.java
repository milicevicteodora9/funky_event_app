...
public class CashboxTransactionAdapter extends RecyclerView.Adapter<CashboxTransactionAdapter.Holder> {
    public interface Listener { void onEdit(CashboxTransaction item); void onDelete(CashboxTransaction item); }
    ...
    class Holder extends RecyclerView.ViewHolder {
        TextView amount,name,dateText,purpose; Holder(View v){super(v);amount=v.findViewById(R.id.textTransactionAmount);name=v.findViewById(R.id.textTransactionName);dateText=v.findViewById(R.id.textTransactionDate);purpose=v.findViewById(R.id.textTransactionPurpose);v.findViewById(R.id.buttonEditTransaction).setOnClickListener(x->listener.onEdit(items.get(getBindingAdapterPosition())));v.findViewById(R.id.buttonDeleteTransaction).setOnClickListener(x->listener.onDelete(items.get(getBindingAdapterPosition())));}
